...
export const metadata: Metadata = {
  ...
  description:
    "Stadium Operations Mission Control for FIFA World Cup 2026 organizers.",
};
        ...
        <div className="container mx-auto flex h-14 items-center px-4 md:px-8 justify-between">
          <div className="flex items-center gap-4">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="font-heading text-lg font-bold tracking-tight text-white uppercase">
                StadiumOS{" "}
                <span className="text-[var(--accent-cyan)] opacity-80">
                  Command
                </span>
              </span>
            </Link>
          ...
          <div className="flex items-center gap-4 text-xs font-mono text-zinc-500">
            <div className="hidden md:flex items-center gap-4">
              ...
              >
                <LayoutDashboard className="w-3.5 h-3.5" /> Fan Hub
              </Link>
              <Link
                href="/copilot"
                className="flex items-center gap-1.5 hover:text-zinc-300 transition-colors"
