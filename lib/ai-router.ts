...
const RESPONSE_MAP: Array<{ keywords: string[]; response: string }> = [
  ...
  {
    keywords: ["route", "navigate", "directions", "find", "where", "seat", "gate"],
    response:
  ...
  {
    keywords: ["food", "eat", "drink", "concession", "beverage", "queue", "wait"],
    response:
  ...
  {
    keywords: ["metro", "transport", "bus", "train", "parking", "shuttle", "traffic"],
    response:
  ...
  {
    keywords: ["security", "incident", "alert", "emergency", "danger", "threat"],
    response:
  ...
  {
    keywords: ["summarize", "summary", "overview", "status", "update", "incident"],
    response:
