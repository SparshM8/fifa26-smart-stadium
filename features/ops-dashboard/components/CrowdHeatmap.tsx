    ...
    <Card className="h-[400px]">
      ...
      <CardContent className="h-[300px] relative">
        <div className="absolute inset-4 border border-white/5 bg-white/[0.02] rounded-[40%] flex items-center justify-center overflow-hidden">
          ...
          <div
            className="absolute bottom-[20%] right-[30%] w-24 h-24 bg-[var(--warning)]/30 blur-[30px] rounded-full animate-pulse"
            style={{ animationDelay: "1s" }}
          />
          <div
            className="absolute top-[40%] right-[15%] w-40 h-40 bg-[var(--danger)]/20 blur-[50px] rounded-full animate-pulse"
        ...
        <div className="absolute bottom-6 right-6 bg-black/80 backdrop-blur-md rounded-lg p-3 border border-white/10 flex flex-col gap-2">
          <div className="flex items-center gap-2 text-xs text-white">
            <div className="w-3 h-3 rounded-full bg-[var(--danger)]" /> High
            Density
          </div>
          <div className="flex items-center gap-2 text-xs text-white">
