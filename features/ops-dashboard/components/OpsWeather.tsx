      ...
      <CardContent className="p-5">
        <div className="grid grid-cols-3 gap-4 divide-x divide-white/10">
          ...
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <div className="font-heading font-bold text-white text-xl">
              14 <span className="text-sm text-zinc-500">km/h</span>
            </div>
            <div className="text-[10px] text-zinc-500 uppercase tracking-wider">
              Wind Shear
            </div>
          ...
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <div className="font-heading font-bold text-[var(--warning)] text-xl">
              12 <span className="text-sm text-zinc-500">km</span>
            </div>
            <div className="text-[10px] text-[var(--warning)] uppercase tracking-wider">
              Lightning Prox.
            </div>
          </div>
        </div>
