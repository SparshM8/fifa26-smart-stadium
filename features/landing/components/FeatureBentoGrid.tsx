    ...
    <section className="py-24 max-w-7xl mx-auto px-6">
      <div className="mb-16 text-center">
        <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-white mb-4">
          Everything you need to <br className="hidden md:block" /> run a World
          Cup stadium.
        </h2>
        <p className="text-zinc-400 max-w-2xl mx-auto">
          A unified platform integrating thousands of data points into simple,
          ...
          <div className="p-8 h-full flex flex-col justify-between relative z-10">
            ...
            <div>
              <h3 className="text-2xl font-bold text-white mb-2">
                Logistics Neural Network
              </h3>
              <p className="text-zinc-400 max-w-md">
                Connects transport APIs, traffic cameras, and parking sensors to
                optimize fan arrival and departure.
              </p>
            </div>
          </div>
          ...
          <div className="p-8 h-full flex flex-col justify-between relative z-10">
            ...
            <div>
              ...
              <p className="text-zinc-400 text-sm">
                AI-driven anomaly detection identifies potential threats before
                they escalate.
              </p>
            </div>
          </div>
        ...
        >
          ...
          <div className="p-8 h-full flex flex-col justify-between relative z-10">
            ...
            <div>
              ...
              <p className="text-zinc-400 text-sm">
                Process thousands of camera feeds locally for zero-latency
                operations.
              </p>
            </div>
          </div>
            ...
            <div className="flex items-end justify-between">
              <div>
                ...
                <p className="text-zinc-400 max-w-sm">
                  Integrates natively with ticketing platforms, digital signage,
