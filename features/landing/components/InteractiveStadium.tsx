    ...
    <section className="py-32 relative overflow-hidden flex flex-col items-center justify-center bg-[#03050c]">
      ...
      <div className="relative w-full max-w-4xl h-[400px] md:h-[500px] mx-auto perspective-[1200px]">
        ...
        >
          ...
          <svg
            viewBox="0 0 800 600"
            className="w-[85%] h-[85%] text-white/5 relative z-0"
          >
            <defs>
              <linearGradient
                id="blueprint-pitch-grad"
                x1="0"
                y1="0"
                x2="0"
                y2="1"
            ...
            <path
              d="M 180 180 L 100 100 M 620 180 L 700 100 M 180 420 L 100 500 M 620 420 L 700 500"
          ...
          {[
            {
              ...
              left: "28%",
              color: "bg-rose-500",
              label: "Sector B Thermal Alert",
            },
            {
              top: "72%",
              left: "68%",
              color: "bg-blue-500",
              label: "Gate C High Occupancy",
            },
            {
              top: "45%",
              left: "76%",
              color: "bg-emerald-500",
              label: "Gate B Access Nominal",
            },
            {
              top: "58%",
              left: "22%",
              color: "bg-amber-500",
              label: "Turnstile Loop Slowdown",
            },
          ].map((node, i) => (
            <div
              key={i}
            ...
            >
              <span className="relative flex h-5 w-5">
                ...
                ></span>
                <span
                  className={`relative inline-flex rounded-full h-5 w-5 border border-white/20 shadow-lg ${node.color}`}
                ></span>
              </span>
