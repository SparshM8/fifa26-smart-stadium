...
export function ChatArea({
  ...
  return (
    <div
      className="flex-1 overflow-y-auto px-4 md:px-12 py-8 flex flex-col"
      ref={scrollRef}
    >
      {messages.length === 0 && (
        <div className="flex-1 flex flex-col items-center justify-center text-center opacity-50">
          ...
          <p className="text-zinc-400 max-w-md font-sans">
            Connected to all stadium feeds, sensors, and operational
            intelligence. How can I assist you today?
          </p>
        </div>
      )}
