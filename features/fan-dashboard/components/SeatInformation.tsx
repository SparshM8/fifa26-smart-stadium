    ...
    <Card>
      <CardContent className="p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="font-heading font-bold text-white text-lg">Your Seat</h3>
            <p className="font-sans text-xs text-zinc-400">Estadio Azteca, Mexico City</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="bg-white/5 rounded-xl p-3 text-center border border-white/5">
            ...
            <div className="font-heading font-bold text-white text-xl">F-24</div>
          </div>
        </div>
      </CardContent>
    </Card>
