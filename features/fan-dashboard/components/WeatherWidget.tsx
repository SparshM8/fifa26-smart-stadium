...
import { CloudRain, CloudLightning, Wind, Thermometer, Droplets } from "lucide-react"
      ...
      <CardContent className="p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="font-heading font-bold text-white text-2xl">{w.temperature}°C</span>
            </div>
            <div className="text-sm text-blue-200">{w.description} · MetLife Stadium</div>
          </div>
        ...
        {w.lightningProximityKm !== null && (
          <div
            ...
            aria-live="polite"
          >
            <CloudLightning className="w-4 h-4 text-[var(--warning)] shrink-0" aria-hidden="true" />
        ...
        <div className="mt-3 grid grid-cols-2 gap-2">
          <div className="bg-white/5 rounded-lg px-3 py-2 text-center">
            <Thermometer className="w-3.5 h-3.5 text-zinc-400 mx-auto mb-1" aria-hidden="true" />
          ...
          <div className="bg-white/5 rounded-lg px-3 py-2 text-center">
            ...
            <div className="text-sm font-bold text-white">{w.uvIndex} <span className="text-zinc-500 font-normal text-xs">Moderate</span></div>
          </div>
        </div>
      </CardContent>
    </Card>
