        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-white">{foodQueue.label}</span>
            </div>
            <Badge variant={foodQueue.status === "high" ? "warning" : "success"}>
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-white">{restroomQueue.label}</span>
            </div>
            <Badge variant={restroomQueue.status === "moderate" ? "warning" : "success"}>
          ...
          >
            <motion.div
              ...
              transition={{ duration: 1, ease: "easeOut" }}
              className="h-full rounded-full"
              style={{ backgroundColor: getLoadColor(restroomQueue.currentLoad) }}
            />
          </div>
        </div>
