      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center gap-4 bg-white/5 p-4 rounded-[16px] border border-white/5">
          ...
          <div className="text-right">
             <div className="text-sm font-bold text-[var(--success)]">On Time</div>
        ...
        <div className="flex items-center gap-4 bg-white/5 p-4 rounded-[16px] border border-white/5">
          ...
          <div className="flex-1">
             <div className="text-sm font-bold text-white">VIP Parking (Lot A)</div>
             <div className="text-xs text-zinc-400">Your registered vehicle</div>
          </div>
          <div className="text-right">
             <div className="text-sm font-bold text-[var(--warning)]">85% Full</div>
