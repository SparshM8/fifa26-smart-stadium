    ...
    <div className="flex flex-col h-full bg-[#03050f] text-white border-r border-white/5">
      ...
      >
        ...
        <span className="font-heading text-base font-bold tracking-tight">
          ...
          <span className="text-zinc-500 font-normal text-xs">AI</span>
        </span>
      </Link>
      ...
      <div className="px-3 pt-4 pb-2">
        <div className="flex items-center gap-2 px-3 py-2 bg-[var(--danger)]/10 border border-[var(--danger)]/20 rounded-xl">
          ...
          <div>
            <div className="text-[10px] font-bold text-[var(--danger)] uppercase tracking-wider">
              Live Match
            </div>
      ...
      <div className="px-3 py-2 flex-1 overflow-y-auto">
        <div className="text-[10px] font-bold text-zinc-600 uppercase tracking-wider px-3 mb-2">
          Navigation
        </div>
