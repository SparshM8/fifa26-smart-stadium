...
export function AIPanel({ className }: { className?: string }) {
  return (
    <div className={cn("relative glass-panel rounded-[24px] overflow-hidden flex flex-col h-[400px]", className)}>
      {/* Glow Effect */}
      ...
      <div className="p-4 border-b border-white/5 bg-white/5 flex items-center gap-3">
        ...
        <div>
          <h4 className="text-white font-heading font-semibold text-sm">StadiumOS Copilot</h4>
          <p className="text-xs text-[var(--accent-cyan)] font-mono">System Online</p>
        </div>
      </div>
